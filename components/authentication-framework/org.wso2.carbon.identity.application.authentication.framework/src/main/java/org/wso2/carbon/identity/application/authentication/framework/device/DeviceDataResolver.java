...
package org.wso2.carbon.identity.application.authentication.framework.device;
...
public interface DeviceDataResolver {
     ...
     * @return The verified device payload, or an empty optional if no device token is present.
     */
