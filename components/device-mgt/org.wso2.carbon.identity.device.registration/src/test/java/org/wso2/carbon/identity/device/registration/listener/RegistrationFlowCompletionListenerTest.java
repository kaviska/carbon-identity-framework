...
public class RegistrationFlowCompletionListenerTest {
    ...
    private DeviceOwner argThatOwnerUserIdMatches(String expectedUserId) {

        ArgumentMatcher<DeviceOwner> matcher = owner -> owner instanceof DeviceUser
                && expectedUserId.equals(((DeviceUser) owner).getUserId())
                && DEVICE_ID.equals(((DeviceUser) owner).getDeviceId());
