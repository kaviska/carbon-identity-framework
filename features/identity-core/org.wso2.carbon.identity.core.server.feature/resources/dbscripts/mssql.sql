...
CREATE TABLE IDN_OAUTH2_TOKEN_BINDING (
            ...
            FOREIGN KEY (TOKEN_ID) REFERENCES IDN_OAUTH2_ACCESS_TOKEN(TOKEN_ID) ON DELETE CASCADE,
            CONSTRAINT PK_TOKEN_BINDING PRIMARY KEY (ID)
);
...
IF NOT  EXISTS (SELECT * FROM SYS.OBJECTS WHERE OBJECT_ID = OBJECT_ID(N'[DBO].[IDN_OAUTH2_REFRESH_TOKEN_BINDING]') AND TYPE IN (N'U'))
