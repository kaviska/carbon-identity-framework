...
CREATE TABLE IDN_OAUTH2_TOKEN_BINDING (
            ...
            PRIMARY KEY (ID))
/
CREATE SEQUENCE IDN_OAUTH2_TOKEN_BINDING_SEQ START WITH 1 INCREMENT BY 1 CACHE 20 ORDER
/
CREATE OR REPLACE TRIGGER IDN_OAUTH2_TOKEN_BINDING_TRIG
            BEFORE INSERT
            ON IDN_OAUTH2_TOKEN_BINDING
            REFERENCING NEW AS NEW
            FOR EACH ROW
                BEGIN
...
CREATE TABLE IDN_SECRET (
    ...
    SECRET_VALUE VARCHAR(4000),
    SECRET_VALUE_CLOB CLOB,
    CREATED_TIME TIMESTAMP NOT NULL,
    LAST_MODIFIED TIMESTAMP NOT NULL,
    TYPE_ID VARCHAR2(255) NOT NULL,
    DESCRIPTION VARCHAR2(1023) NULL,
...
CREATE OR REPLACE TRIGGER IDN_RULE_REFERENCES_TRIGGER
    ...
    REFERENCING NEW AS NEW FOR EACH ROW
        ...
        END;
/
CREATE TABLE IDN_DEVICE_POLICY (
    ID          INTEGER,
...
/
CREATE SEQUENCE IDN_DEVICE_POLICY_SEQ START WITH 1 INCREMENT BY 1 NOCACHE
/
CREATE OR REPLACE TRIGGER IDN_DEVICE_POLICY_TRIGGER
    BEFORE INSERT ON IDN_DEVICE_POLICY
    REFERENCING NEW AS NEW FOR EACH ROW
        BEGIN
          SELECT IDN_DEVICE_POLICY_SEQ.nextval INTO :NEW.ID FROM dual;
        END;
/
...
/
CREATE SEQUENCE IDN_VC_TEMPLATE_CURSOR_KEY_SEQ START WITH 1 INCREMENT BY 1 NOCACHE
/
...
/
CREATE SEQUENCE IDN_VC_CLAIMS_SEQ START WITH 1 INCREMENT BY 1 NOCACHE
/
...
CREATE TABLE IDN_OAUTH2_REFRESH_TOKEN_BINDING (
    REFRESH_TOKEN_ID VARCHAR2 (255) NOT NULL,
    TOKEN_BINDING_TYPE VARCHAR2 (32) NOT NULL,
    TOKEN_BINDING_REF VARCHAR2 (32) NOT NULL,
    TOKEN_BINDING_VALUE VARCHAR2 (1024) NOT NULL,
    TENANT_ID INTEGER DEFAULT -1,
